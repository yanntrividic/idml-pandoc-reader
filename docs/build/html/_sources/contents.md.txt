...
* `maps` et `map.json.sample` contiennent des fichiers JSON exemples montrant comment paramétrer la conversion en fonction des spécificités de chaque livre, voir [Correspondance des styles](/usage.html/#correspondance_des_styles) ;
...
* `idml.lua` fait le lien entre `idml2docbook` et Pandoc, voir (/usage.html/#commandes_de_base) ;
