...
Un script d'installation `install.sh` pour Mac et Linux a été développé afin de faciliter la prise en main de ce logiciel. Ce script a principalement pour fonctions de :
